...
function PreSaveAction(){
    var whwhat = $("textarea[oldtitle$='5W1H - the What']").val();
	var whwhen = $("textarea[oldtitle$='5W1H - the When']").val();
	var whwhere = $("textarea[oldtitle$='5W1H - the Where']").val();
	var whwho = $("textarea[oldtitle$='5W1H - the Who']").val();
	var whwhich = $("textarea[oldtitle$='5W1H - the Which']").val();
	var whhow = $("textarea[oldtitle$='5W1H - the How']").val();
    if ($("select[title$='Site']").val()=="Minto" || $("select[title$='Site']").val()=="North Rocks" || $("select[title$='Site']").val()=="Petone" || $("select[title$='Site']").val()=="Tatura") {
		if (whwhat.length < 1) {
				alert("Please enter 5W1H - the What before saving it again.");
				return false;
		}
		if (whwhen.length < 1) {
				alert("Please enter 5W1H - the When before saving it again.");
				return false;
		}
		if (whwhere.length < 1) {
				alert("Please enter 5W1H - the Where before saving it again.");
				return false;
		}
		if (whwho.length < 1) {
				alert("Please enter 5W1H - the Who before saving it again.");
				return false;
		}
		if (whwhich.length < 1) {
				alert("Please enter 5W1H - the Which before saving it again.");
				return false;
		}
		if (whhow.length < 1) {
				alert("Please enter 5W1H - the How before saving it again.");
				return false;
		}
		return true;
    } else {
...
$("nobr:containsExactCase('Other Relevant Supervisor-Manager 2')").parent('h3').parent('td').parent('tr').qtip({ 
    content: {
      text: 'If you believe some other supervisors and managers are relevant to this and should be notified or involved in the investigation, please enter their name here. You can only Enter one name at a time.<br><br>Please do NOT enter any Sourcing Unit Director, SHE Manager, Vice President or WHS Coordinator names because they already get notifications for all incidents reported.',
      title: 'Optional field'
    },
...
$("nobr:containsExactCase('Other Relevant Supervisor-Manager 3')").parent('h3').parent('td').parent('tr').qtip({ 
    content: {
      text: 'If you believe some other supervisors and managers are relevant to this and should be notified or involved in the investigation, please enter their name here. You can only Enter one name at a time.<br><br>Please do NOT enter any Sourcing Unit Director, SHE Manager, Vice President or WHS Coordinator names because they already get notifications for all incidents reported.',
      title: 'Optional field'
    },
